...
const QuemSou = () => {
	return <Container>
		...
		<div className="descricao">
			...
			<p>Trabalhei como freelancer utilizando da <span>Unreal Engine</span>, desenvolvendo mecânicas utilizando das <span>BluePrints</span>.</p>
			
			<p>Em paralelo com a faculdade eu trabalhei como <span>Web Developer</span>,
			de Janeiro de 2018 até Maio de 2020. Obtive experiência com diversas tecnologias de desenvolvimento Web durante esse período
